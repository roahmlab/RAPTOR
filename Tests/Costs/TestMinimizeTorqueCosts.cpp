#define BOOST_TEST_MODULE MinimizeTorqueTest
...
BOOST_AUTO_TEST_SUITE(MinimizeTorqueTest)
...
BOOST_AUTO_TEST_CASE(GradientTest) {
    ...
    std::shared_ptr<Costs> costPtr_ = std::make_shared<MinimizeTorque>(trajPtr_, idPtr_);
