...
constexpr double TORQUE_LIMITS_LOWER[NUM_JOINTS] = {-80.0, -80.0, -80.0, -80.0, -40.0, -40.0, -40.0}; // N*m

// constexpr double TORQUE_LIMITS_UPPER[NUM_JOINTS] = {56.7, 56.7, 56.7, 56.7, 29.4, 29.4, 29.4}; // N*m
constexpr double TORQUE_LIMITS_UPPER[NUM_JOINTS] = {80.0, 80.0, 80.0, 80.0, 40.0, 40.0, 40.0}; // N*m
