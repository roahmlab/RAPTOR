...
%%
for i = 1:num_trails
    ipopt_filename = sprintf('ipopt_digit-modified-Bezier-%d-N16.out', i);
%     ipopt_filename = sprintf('/home/roahmlab/Documents/TROPIC/examples/digit-modified/ipopt-%d.out', i);
...
%%
% save('comp-TROPIC.mat', 'data1', "data2", "data3");
