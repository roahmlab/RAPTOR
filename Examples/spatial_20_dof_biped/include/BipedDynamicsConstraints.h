#ifndef Biped_CONSTRAINTS_H
#define Biped_CONSTRAINTS_H

#include <string>
#include <vector>

#include "BipedConstants.h"
...
class BipedDynamicsConstraints : public DynamicsConstraints {
public:
    ...
    // Constructor
    BipedDynamicsConstraints() = default;

    // Constructor
    BipedDynamicsConstraints(const std::shared_ptr<Model>& modelPtr_input,
                             char stanceLeg, 
