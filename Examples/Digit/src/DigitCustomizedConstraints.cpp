...
void DigitCustomizedConstraints::compute(const VecX& z, 
    ...
    g7 = q.row(1) - 0.5 * swingfoot_xyzrpy.row(1); // torso stays between the two feet
    g8 = Utils::wrapToPi(q.row(3)); // torso roll
    g9 = Utils::wrapToPi(q.row(4)); // torso pitch
    g10 = (ddcPtr_->stanceLeg == 'L') ?
...
void DigitCustomizedConstraints::compute_bounds() {
    ...
    g7_lb = VecX::Constant(trajPtr_->N, -0.08);
    g7_ub = VecX::Constant(trajPtr_->N, 0.08);
    ...
    g_lb << g1_lb, g2_lb, g3_lb, g4_lb, g5_lb, g6_lb, g7_lb, g8_lb, g9_lb, g10_lb;
    g_ub << g1_ub, g2_ub, g3_ub, g4_ub, g5_ub, g6_ub, g7_ub, g8_ub, g9_ub, g10_ub;
}
